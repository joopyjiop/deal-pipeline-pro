      ...
      <div className="mx-auto flex w-full max-w-[1500px] gap-5">
        <aside className="glass-panel hidden w-[245px] shrink-0 flex-col rounded-[1.75rem] p-4 lg:flex">
          ...
          <nav className="space-y-1" aria-label="Workspace navigation">
            ...
            <div className="flex items-center gap-3 rounded-xl px-3 py-2.5 text-sm font-medium text-slate-500"><BarChart3 className="size-4" /> Pipeline pulse <Badge variant="outline" className="ml-auto border-white/80 bg-white/45 text-[0.6rem] text-slate-400">V1</Badge></div>
